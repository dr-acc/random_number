defmodule RandomNumberWeb.CoreComponents do
  @moduledoc """
  ...
  import RandomNumberWeb.Gettext
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RandomNumberWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RandomNumberWeb.Gettext, "errors", msg, opts)
    end
  end
